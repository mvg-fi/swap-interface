import fourpoolSwapABI from '$lib/constants/abis/4pool/swap.json';
import tricrypto2DepositABI from '$lib/constants/abis/tricrypto/deposit.json';
import tricrypto2SwapABI from '$lib/constants/abis/tricrypto/swap.json';
import { lowerCasePoolDataAddresses } from "$lib/helpers/utils";
import type { IDict, IPoolData } from "$lib/constants/interfaces";

export const POOLS_DATA_MVM: IDict<IPoolData> = lowerCasePoolDataAddresses({
    stable: {
        name: "stable",
        full_name: "stable",
        symbol: "stable",
